...
public class AyudaActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try{
			...
			vf.addView(addImageView(R.mipmap.ayuda_img1));
			vf.addView(addImageView(R.mipmap.ayuda_img2));
			vf.addView(addImageView(R.mipmap.ayuda_img3));
			vf.addView(addImageView(R.mipmap.ayuda_img4));
			vf.addView(addImageView(R.mipmap.ayuda_img5));
		}catch(Exception ex){
			ex.printStackTrace();
		}
	}
